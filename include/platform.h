...
[[nodiscard]] inline auto get_app_data(GetEnvFn getenv, std::string_view const name)
...
[[nodiscard]] inline auto get_local_app_data(GetEnvFn getenv, std::string_view const name)
    -> std::optional<std::filesystem::path> {
...
[[nodiscard]] inline auto get_application_support(GetEnvFn getenv, std::string_view const name)
    -> std::optional<std::filesystem::path> {
...
[[nodiscard]] inline auto get_config_home(GetEnvFn getenv, std::string_view const name)
    -> std::optional<std::filesystem::path> {
...
[[nodiscard]] inline auto get_data_home(GetEnvFn getenv, std::string_view const name)
    -> std::optional<std::filesystem::path> {
...
[[nodiscard]] auto get_config_dir(GetEnvFn getenv, std::string_view const name)
    -> std::optional<std::filesystem::path> {
...
template <Platform p = get_platform()>
[[nodiscard]] auto get_data_dir(GetEnvFn getenv, std::string_view const name)
    -> std::optional<std::filesystem::path> {
    if constexpr (p == Platform::Windows) {
