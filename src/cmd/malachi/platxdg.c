...
static char *xdgconfighome(Getenvfn getenv, char const *name)
{
    assert(name != NULL);
...
static char *xdgdatahome(Getenvfn getenv, char const *name)
{
    assert(name != NULL);
...
static char *xdgcachehome(Getenvfn getenv, char const *name)
{
    assert(name != NULL);
...
static char *xdgruntimedir(Getenvfn getenv, char const *name)
{
    assert(name != NULL);
